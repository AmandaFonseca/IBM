	    ...
	    if (restclient) {
	      ...
	      try {
	        if (this.authType && this.authType.toUpperCase() === 'FORM') {
              ...
              //options.query.j_username = options.username;
	  ...
	  */
	  ...
	  async login(options) {
	    ...
	    */
        ...
        if (this.client.response.redirected &&
                    this.client.authenticator.authType &&
                    this.client.authenticator.authType.toUpperCase() == 'FORM' &&
                    this.client.response.headers.get('content-type') &&
                    this.client.response.headers.get('content-type').indexOf('text/html') != -1) {
                	      response.authenticated = false;
