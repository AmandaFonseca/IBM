...
function(declare, ModelService, array, ApplicationHandlerBase, WorkOrderObject, TaskObject, WorkOrderTimer, WorkOrderStatusHandler, PlatformRuntimeException, PlatformRuntimeWarning, CommonHandler, PlatformConstants, FormatterService,SynonymDomain, Logger, MaxVars, MessageService, DataSheetObject,lang) {
...
/**@memberOf application.handlers.StatusChangeHandler */
		...
		saveClassify2: function(eventContext) {
			...
			wo.setDateValue("pd_inspdate", currentData);
			if (wo.get('status') == "PREPLAN") {
