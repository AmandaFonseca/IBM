...
function(declare, all, StoresBuilderBase, ResourceMetadata, PersistenceManager, WorkOrderObject, AttachmentsObject, TaskObject, AssignmentObject, PlannedMaterialObject, PlannedToolObject, ActualLaborObject, ActualMaterialObject, ActualToolObject, WoStatusObject, CrewLaborObject, CrewToolObject, ClassStructureObject, MaxDomainObject) {
      return declare("generated.application.data.ApplicationStoresBuilder", StoresBuilderBase, {
         ...
         _buildStoresAsync : function(promise) {
            ...
            var resource004 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('spi_wm:ms_inspwhy,spi_wm:ms_acceptinsp,spi_wm:ms_inspector04,spi_wm:ms_inspdate04,spi_wm:ms_reinspec04,spi_wm:pd_inspdate,spi_wm:pd_inspquestion01,spi_wm:pd_inspquestion02,spi_wm:pd_inspquestion03,spi_wm:ms_inspquestion04,spi_wm:pd_inspector,spi_wm:pd_seqinspec,spi_wm:ms_inspremarks,spi_wm:ms_aging,dcterms:identifier,dcterms:title,dcterms:description,oslc:shortTitle,dcterms:created,spi_wm:schedstart,spi_wm:schedfinish,spi_wm:actstart,spi_wm:actfinish,spi:status,spi_wm:worktype,spi_wm:wopriority,spi_wm:classstructureid,spi_wm:pd_obs,spi_wm:parentchgsstatus,spi_wm:siteid,spi_wm:orgid,spi_wm:np_statusmemo,spi_wm:statusdate,spi_wm:istask,spi_wm:calculatedy,spi_wm:calculatedx,spi_wm:anywhereundo,spi_wm:parentwonuminsp{dcterms:title,oslc:shortTitle},spi:asset{spi:updownstatus{spi:changedate},spi:description_longdescription,dcterms:title,spi:isrunning,oslc:shortTitle},spi_wm:ms_inspectionapp{spi_wm:ms_reinspec,spi_wm:ms_allowaccept,spi_wm:ms_acceptinsp,spi_wm:ms_insppriority,spi_wm:ms_insptype,spi_wm:ms_inspectionid,spi_wm:ms_canceldate,spi_wm:ms_assigntype,spi_wm:ms_inspreqdate,spi_wm:ms_laborcode},spi:woserviceaddress{spi_wm:latitudey,spi_wm:addressline2,spi_wm:longitudex,spi_wm:staddrnumber,spi_wm:addressline3,spi_wm:stateprovince,spi_wm:city,spi_wm:description,spi_wm:formattedaddress,spi_wm:saddresscode,spi_wm:postalcode}').
               setSupportiveFieldsSelectExpression('spi_wm:task{spi_wm:taskid,dcterms:title,spi_wm:description_longdescription,spi:status,spi_wm:schedstart,spi_wm:parent,spi_wm:istask,spi_wm:statusdate,spi_wm:np_statusmemo,spi_wm:siteid,oslc:shortTitle,spi_wm:parentchgsstatus,spi:asset{spi:description_longdescription,dcterms:title,oslc:shortTitle}},spi_wm:assignment{spi_wm:assignmentid,spi_wm:taskid,spi_wm:laborcode,spi_wm:laborname,spi_wm:craft,spi_wm:skilllevel,spi_wm:amcrew,spi_wm:amcrewtype,spi_wm:status,spi_wm:scheduledate,spi_wm:laborhrs,spi_wm:vendor,spi_wm:contractnum},spi_wm:wpmaterialinsp{spi_wm:wpitemid,spi_wm:taskid,spi_wm:itemnum,spi_wm:description,spi_wm:description_longdescription,spi_wm:itemqty,spi_wm:linetype,spi_wm:directreq,spi_wm:itemsetid,spi_wm:storelocsite,spi_wm:requestnum},spi_wm:wptoolinsp{spi_wm:wpitemid,spi_wm:itemnum,spi_wm:taskid,spi_wm:description,spi_wm:description_longdescription,spi_wm:itemqty,spi_wm:hours,spi_wm:linetype,spi_wm:itemsetid},spi_wm:actuallaborinsp{dcterms:identifier,spi_wm:taskid,spi_wm:laborcode,foaf:name,spi_wm:craft,spi_wm:skilllevel,spi_wm:vendor,spi_wm:contractnum,spi_wm:revisionnum,spi_wm:amcrew,spi_wm:position,spi_wm:startdate,spi_wm:starttime,spi_wm:finishdate,spi_wm:finishtime,spi_wm:regularhrs,spi_wm:premiumpayhours,spi_wm:premiumpaycode,spi_wm:transtype,spi_wm:timerstatus,spi_wm:anywhererefid},spi_wm:actualmaterialinsp{dcterms:identifier,spi_wm:itemsetid,spi_wm:taskid,spi_wm:itemnum,dcterms:title,spi_wm:positivequantity,spi_wm:linetype,spi_wm:storeloc,spi_wm:binnum,spi_wm:rotassetnum,spi_wm:tositeid,spi_wm:anywhererefid,spi_wm:requestnum,spi_wm:enteredastask},spi_wm:actualtoolinsp{dcterms:identifier,spi_wm:taskid,spi_wm:toolhrs,spi_wm:rotassetnum,spi_wm:amcrew,spi_wm:itemsetid,spi_wm:anywhererefid,spi_wm:plusctechnician,spi_wm:plusccomment,spi_wm:pluscduedate,spi_wm:plusctoolusedate,spi_wm:transdate,spi_wm:pluscexpirydate,spi_wm:plusclotnum,spi_wm:pluscmanufacturer,spi_wm:plusctype,spi_wm:rotassetsite,spi:toolitem{spi:itemnum,dcterms:title,spi:pluscsolution}},spi:attachments{oslc_cm:attachmentSize,dcterms:title,spi:fileName,dcterms:description,dcterms:created,spi:urlType,spi:docType,spi:printthrulink,spi:contentLocation,spi:anywhererefid,spi:createby},spi_wm:workorderspec{spi_wm:workorderspecid,spi_wm:classstructureid,spi_wm:mandatory,spi_wm:refobjectname,spi_wm:orgid,spi_wm:changedate,spi_wm:displaysequence,spi_wm:changeby,spi_wm:refobjectid,spi_wm:numvalue,spi_wm:alnvalue,spi_wm:tablevalue,spi_wm:section,spi_wm:measureunitid,spi_wm:anywhererefid,spi_wm:classspec{spi_wm:domainid,spi_wm:classspecid{spi_wm:classspecid}},spi_wm:assetattr{spi_wm:assetattrid,spi_wm:description,spi_wm:datatype}}').
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi_wm:ms_reinspec',
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_reinspec',
                  'index' : false,
                  'artifactId' : 'ms_reinspec',
                  'id' : 'aw9f1a70dc',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               }).
               addField({
                  ...
                  'name' : 'ms_inspwhy',
                  'index' : false,
                  'artifactId' : 'ms_inspwhy',
                  'maxSize' : 10,
                  'id' : 'awae65f2b1',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspwhy',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'displayValueRemoteName' : 'spi_wm:ms_assigntype',
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_assigntype',
                  'index' : false,
                  'artifactId' : 'ms_assigntype',
                  'maxSize' : 10,
                  'id' : 'awabaaf7a4',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               ...
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi_wm:ms_allowaccept',
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_allowaccept',
                  'index' : false,
                  'artifactId' : 'ms_allowaccept',
                  'id' : 'aw617d9c11',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'displayValueRemoteName' : 'spi_wm:ms_canceldate',
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_canceldate',
                  'index' : false,
                  'artifactId' : 'ms_canceldate',
                  'id' : 'aw7fefa4e2',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi_wm:ms_acceptinsp',
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_inspection_acc',
                  'index' : false,
                  'artifactId' : 'ms_inspection_acc',
                  'id' : 'aw4c7a45a',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi_wm:ms_insppriority',
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_insppriority',
                  'index' : false,
                  'artifactId' : 'ms_insppriority',
                  'id' : 'aw8c175575',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               }).
               addField({
                  ...
                  'name' : 'ms_acceptinsp',
                  'index' : false,
                  'artifactId' : 'workorder_ms_inspection_ms_acceptinsp',
                  'maxSize' : 1,
                  'id' : 'aw2e434a0c',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_acceptinsp',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi_wm:ms_inspectionid',
                  'dataType' : 'inline',
                  'usage' : 'bigint',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_inspectionid',
                  'index' : false,
                  'artifactId' : 'workorder_ms_inspection_ms_inspectionid',
                  'id' : 'aw1ed925b9',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'displayValueRemoteName' : 'spi_wm:ms_laborcode',
                  'dataType' : 'inline',
                  'usage' : 'upper',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_laborcode',
                  'index' : false,
                  'artifactId' : 'workorder_ms_inspection_ms_laborcode',
                  'maxSize' : 8,
                  'id' : 'awf11328fc',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               ...
               addField({
                  'multiplicity' : 'zero-or-one',
                  'displayValueRemoteName' : 'spi_wm:ms_inspreqdate',
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_inspreqdate',
                  'index' : false,
                  'artifactId' : 'workorder_ms_inspection_ms_inspreqdate',
                  'id' : 'aw2a122cda',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'displayValueRemoteName' : 'spi_wm:ms_insptype',
                  'dataType' : 'inline',
                  'usage' : 'upper',
                  'referenceResource' : 'workOrder',
                  'name' : 'ms_insptype',
                  'index' : false,
                  'artifactId' : 'workorder_ms_inspection_ms_insptype',
                  'maxSize' : 1,
                  'id' : 'awd2b52600',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspectionapp',
               ...
               addField({
                  ...
                  'name' : 'ms_inspector04',
                  'index' : false,
                  'artifactId' : 'ms_inspector04',
                  'maxSize' : 30,
                  'id' : 'awb3fa60e8',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspector04',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'datetime',
                  'name' : 'ms_inspdate04',
                  'index' : false,
                  'artifactId' : 'ms_inspdate04',
                  'id' : 'awea595a67',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspdate04',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'boolean',
                  'name' : 'ms_reinspec04',
                  'index' : false,
                  'artifactId' : 'ms_reinspec04',
                  'id' : 'awc2a3b48c',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_reinspec04',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'datetime',
                  'name' : 'pd_inspdate',
                  'index' : false,
                  'artifactId' : 'pd_inspdate',
                  'id' : 'awbd1325c',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_inspdate',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'pd_inspquestion01',
                  'index' : false,
                  'artifactId' : 'pd_inspquestion01',
                  'maxSize' : 50,
                  'id' : 'awac631f19',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_inspquestion01',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'pd_inspquestion02',
                  'index' : false,
                  'artifactId' : 'pd_inspquestion02',
                  'maxSize' : 50,
                  'id' : 'aw356a4ea3',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_inspquestion02',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'usage' : 'upper',
                  'name' : 'pd_inspquestion03',
                  'index' : false,
                  'artifactId' : 'pd_inspquestion03',
                  'maxSize' : 20,
                  'id' : 'aw426d7e35',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_inspquestion03',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'ms_inspquestion04',
                  'index' : false,
                  'artifactId' : 'ms_inspquestion04',
                  'maxSize' : 50,
                  'id' : 'awc2381712',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspquestion04',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'pd_inspector',
                  'index' : false,
                  'artifactId' : 'pd_inspector',
                  'maxSize' : 30,
                  'id' : 'aw63593ac1',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_inspector',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'integer',
                  'name' : 'pd_seqinspec',
                  'index' : true,
                  'artifactId' : 'pd_seqinspec',
                  'id' : 'aw404aa28',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_seqinspec',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'ms_inspremarks',
                  'index' : false,
                  'artifactId' : 'ms_inspremarks',
                  'maxSize' : 255,
                  'id' : 'awfb02f3d9',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_inspremarks',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'integer',
               ...
               addField({
                  ...
                  'index' : false,
                  'artifactId' : 'workOrder_assetstatusdate_spiassetspistatusdate',
                  'id' : 'aw1eaa82c1',
                  'local' : false,
                  'remoteName' : 'spi:asset.spi:updownstatus',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi:isrunning',
                  'referenceResource' : 'additionalasset',
                  'dataType' : 'reference',
                  'name' : 'assetup',
                  'index' : false,
                  'artifactId' : 'workOrder_assetup_spiassetisspirunning',
                  'id' : 'awc278501',
                  'local' : false,
                  'remoteName' : 'spi:asset',
               }).
               ...
               addField({
                  ...
                  'id' : 'aw5e0821d4',
                  'local' : false,
                  'remoteName' : 'spi_wm:parentwonuminsp',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'displayValueRemoteName' : 'dcterms:title',
               ...
               addField({
                  ...
                  'local' : false,
                  'remoteName' : 'spi_wm:wpmaterialinsp',
                  'selectExpression' : 'spi_wm:wpmaterialinsp{spi_wm:wpitemid,spi_wm:taskid,spi_wm:itemnum,spi_wm:description,spi_wm:description_longdescription,spi_wm:itemqty,spi_wm:linetype,spi_wm:directreq,spi_wm:itemsetid,spi_wm:storelocsite,spi_wm:requestnum}',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
                  ...
                  'local' : false,
                  'remoteName' : 'spi_wm:wptoolinsp',
                  'selectExpression' : 'spi_wm:wptoolinsp{spi_wm:wpitemid,spi_wm:itemnum,spi_wm:taskid,spi_wm:description,spi_wm:description_longdescription,spi_wm:itemqty,spi_wm:hours,spi_wm:linetype,spi_wm:itemsetid}',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
                  ...
                  'local' : false,
                  'remoteName' : 'spi_wm:actuallaborinsp',
                  'selectExpression' : 'spi_wm:actuallaborinsp{dcterms:identifier,spi_wm:taskid,spi_wm:laborcode,foaf:name,spi_wm:craft,spi_wm:skilllevel,spi_wm:vendor,spi_wm:contractnum,spi_wm:revisionnum,spi_wm:amcrew,spi_wm:position,spi_wm:startdate,spi_wm:starttime,spi_wm:finishdate,spi_wm:finishtime,spi_wm:regularhrs,spi_wm:premiumpayhours,spi_wm:premiumpaycode,spi_wm:transtype,spi_wm:timerstatus,spi_wm:anywhererefid}',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
                  ...
                  'local' : false,
                  'remoteName' : 'spi_wm:actualmaterialinsp',
                  'selectExpression' : 'spi_wm:actualmaterialinsp{dcterms:identifier,spi_wm:itemsetid,spi_wm:taskid,spi_wm:itemnum,dcterms:title,spi_wm:positivequantity,spi_wm:linetype,spi_wm:storeloc,spi_wm:binnum,spi_wm:rotassetnum,spi_wm:tositeid,spi_wm:anywhererefid,spi_wm:requestnum,spi_wm:enteredastask}',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
                  ...
                  'local' : false,
                  'remoteName' : 'spi_wm:actualtoolinsp',
                  'selectExpression' : 'spi_wm:actualtoolinsp{dcterms:identifier,spi_wm:taskid,spi_wm:toolhrs,spi_wm:rotassetnum,spi_wm:amcrew,spi_wm:itemsetid,spi_wm:anywhererefid,spi_wm:plusctechnician,spi_wm:plusccomment,spi_wm:pluscduedate,spi_wm:plusctoolusedate,spi_wm:transdate,spi_wm:pluscexpirydate,spi_wm:plusclotnum,spi_wm:pluscmanufacturer,spi_wm:plusctype,spi_wm:rotassetsite,spi:toolitem{spi:itemnum,dcterms:title,spi:pluscsolution}}',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
               ...
               addField({
                  ...
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'Ywoservicelatitudey',
                  'index' : false,
                  'scale' : 10,
                  'artifactId' : 'Ylatitudey',
                  'id' : 'aw197f9eec',
                  'local' : false,
                  'remoteName' : 'spi:woserviceaddress',
               }).
               addField({
                  ...
                  'dataType' : 'inline',
                  'referenceResource' : 'workOrder',
                  'name' : 'Xwoservicelongitudex',
                  'index' : false,
                  'scale' : 10,
                  'artifactId' : 'Xlongitudex',
                  'id' : 'aw1c49aac7',
                  'local' : false,
                  'remoteName' : 'spi:woserviceaddress',
               }).
               ...
               addField({
                  'dataType' : 'string',
                  'name' : 'pdwhy_description',
                  'index' : false,
                  'artifactId' : 'workOrder_pdwhy_description',
                  'id' : 'awac261ca3',
                  'persistent' : true,
                  'local' : true,
               }).
               ...
               setCreationFactories([
                     {name:'createMyAssignedWork', creationString:'\/oslc\/os\/ms_oslcsgzinsp' }
               ]).
               setQueryBases([
                     {name:'searchAllWorkOrders', queryString:'\/oslc\/os\/ms_oslcsgzinsp?savedQuery=getWithComplexQuery', defaultForSearch: true, queryLabel:'' }
               ]);
            ...
            var resource005 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('dcterms:identifier,spi_wm:ms_objectname,spi_wm:pd_whytype,spi_wm:description,spi_wm:pd_active,spi_wm:pd_whynum').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'identifier',
                  'index' : true,
                  'artifactId' : 'pd_whyid_identifier_dctermsidentifier',
                  'maxSize' : 19,
                  'id' : 'awdea240eb',
                  'local' : false,
                  'pkIndex' : 1,
               ...
               addField({
                  ...
                  'name' : 'ms_objectname',
                  'index' : false,
                  'artifactId' : 'ms_objectname',
                  'maxSize' : 30,
                  'id' : 'awc9b0354b',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_objectname',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'pd_whytype',
                  'index' : false,
                  'artifactId' : 'pd_whytype',
                  'maxSize' : 50,
                  'id' : 'awc7ab535',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_whytype',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
               ...
               addField({
                  ...
                  'name' : 'pd_active',
                  'index' : false,
                  'artifactId' : 'pd_active',
                  'id' : 'aw6d4abdc5',
                  'local' : false,
                  'remoteName' : 'spi_wm:pd_active',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
               ...
               setWhereClause('spi_wm%3Apd_active%3D1+and+spi_wm%3Ams_objectname%3D%22WORKORDER%22+and+spi_wm%3Apd_whytype%3D%22PRECANC%22');
            ...
            var resource014 = new ResourceMetadata({
                  ...
                  'inMemory' : true,
                  'pageSize' : 1000,
                  'artifactId' : 'plannedMaterial',
                  'resourceName' : 'plannedMaterial',
                  'id' : 'awb1a8118a',
                  'additionalData' : false,
                  'maxFetchDataLimit' : 0,
                  'isAttachment' : false,
               ...
               addField({
                  ...
                  'name' : 'taskid',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_taskid_spi_wmtaskid',
                  'id' : 'aw6acaeb6c',
                  'persistent' : true,
                  'key' : '1',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'item',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_item_spi_wmitemnum',
                  'id' : 'awbe86178e',
                  'persistent' : true,
                  'key' : '2',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'itemdesc',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_itemdesc_spi_wmdescription',
                  'id' : 'aw5b2dd650',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'itemlongdesc',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_itemlongdesc_spi_wmdescription_longdescription',
                  'id' : 'aw1e1071e8',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'quantity',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_quantity_spi_wmitemqty',
                  'id' : 'awa43a3c57',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'linetype',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_linetype_spi_wmlinetype',
                  'id' : 'aw54d3e7ca',
                  'persistent' : true,
                  'key' : '3',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'storeroom',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_storeroom_spilocationoslcshortTitle',
                  'id' : 'awdb025ef9',
                  'persistent' : true,
                  'key' : '4',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'storeroomdesc',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_storeroomdesc_spilocationdctermstitle',
                  'id' : 'awbee066c2',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'directrequest',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_directrequest_spi_wmdirectreq',
                  'id' : 'aw29b83eab',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'itemanddescription',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_itemanddescription_string',
                  'id' : 'awce09b0ec',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'availableqty',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_quantity_spi_wmitemqty12',
                  'id' : 'aw95c657e3',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'materialCB',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_checkbox_boolean',
                  'id' : 'awbe8d45ab',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'itemsetid',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_itemsetid_string',
                  'id' : 'awc33af559',
                  'persistent' : true,
                  'key' : '5',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'siteid',
                  'index' : false,
                  'artifactId' : 'plannedMaterial_siteid_string',
                  'id' : 'awed7e9453',
                  'persistent' : true,
                  'local' : true,
               });
            ...
            var resource015 = new ResourceMetadata({
                  ...
                  'inMemory' : true,
                  'pageSize' : 1000,
                  'artifactId' : 'plannedTool',
                  'resourceName' : 'plannedTool',
                  'id' : 'aw9e8016a0',
                  'additionalData' : false,
                  'maxFetchDataLimit' : 0,
                  'isAttachment' : false,
               ...
               addField({
                  ...
                  'name' : 'tool',
                  'index' : false,
                  'artifactId' : 'plannedTool_tool_spi_wmitemnum',
                  'id' : 'aw67c46ef9',
                  'persistent' : true,
                  'key' : '1',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'taskid',
                  'index' : false,
                  'artifactId' : 'plannedTool_taskid_spi_wmtaskid',
                  'id' : 'awcf2b8701',
                  'persistent' : true,
                  'key' : '2',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'tooldesc',
                  'index' : false,
                  'artifactId' : 'plannedTool_tooldesc_spi_wmdescription',
                  'id' : 'aw423d6d6e',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'toollongdesc',
                  'index' : false,
                  'artifactId' : 'plannedTool_toollongdesc_spi_wmdescription_longdescription',
                  'id' : 'awa0b68e7b',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'quantity',
                  'index' : false,
                  'artifactId' : 'plannedTool_quantity_spi_wmitemqty',
                  'id' : 'awfa7092c4',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'hours',
                  'index' : false,
                  'artifactId' : 'plannedTool_hours_spi_wmhours',
                  'id' : 'aw94ee4677',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'storeroom',
                  'index' : false,
                  'artifactId' : 'plannedTool_storeroom_spilocationoslcshortTitle',
                  'id' : 'aw7058216c',
                  'persistent' : true,
                  'key' : '3',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'storeroomdesc',
                  'index' : false,
                  'artifactId' : 'plannedTool_storeroomdesc_spilocationdctermstitle',
                  'id' : 'aw726cdf6a',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'toolanddescription',
                  'index' : false,
                  'artifactId' : 'plannedTool_toolanddescription_string',
                  'id' : 'awb284ff7a',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'toolCB',
                  'index' : false,
                  'artifactId' : 'plannedTool_checkbox_boolean',
                  'id' : 'aw83476e4a',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'itemsetid',
                  'index' : false,
                  'artifactId' : 'plannedTool_itemsetid_string',
                  'id' : 'awfef0deb8',
                  'persistent' : true,
                  'key' : '4',
                  'local' : true,
               ...
               addField({
                  'dataType' : 'string',
                  'name' : 'localrotassetnum',
                  'index' : false,
                  'artifactId' : 'plannedTool_rotassetnum_string',
                  'id' : 'aw5925e32c',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'linetype',
                  'index' : false,
                  'artifactId' : 'plannedTool_linetype_string',
                  'id' : 'aw5de06045',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'rotating',
                  'index' : false,
                  'artifactId' : 'plannedTool_rotating_string',
                  'id' : 'aw80e4483c',
                  'persistent' : true,
                  'local' : true,
               });
            ...
            var resource016 = new ResourceMetadata({
                  ...
                  'inMemory' : true,
                  'pageSize' : 1000,
                  'artifactId' : 'plannedLabor',
                  'resourceName' : 'plannedLabor',
                  'id' : 'aw29fbb783',
                  'additionalData' : false,
                  'maxFetchDataLimit' : 0,
                  'isAttachment' : false,
               ...
               addField({
                  ...
                  'name' : 'taskid',
                  'index' : false,
                  'artifactId' : 'plannedLabor_taskid_spi_wmtaskid',
                  'id' : 'aw865a4fde',
                  'persistent' : true,
                  'key' : '1',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'laborcode',
                  'index' : false,
                  'artifactId' : 'plannedLabor_laborcode_spi_wmlaborcode',
                  'id' : 'aw79e69844',
                  'persistent' : true,
                  'key' : '2',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'laborname',
                  'index' : false,
                  'artifactId' : 'plannedLabor_laborname_spi_wmlaborname',
                  'id' : 'aw8affde0c',
                  'persistent' : true,
                  'key' : '3',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'craft',
                  'index' : false,
                  'artifactId' : 'plannedLabor_craft_spi_wmcraft',
                  'id' : 'aw44e90777',
                  'persistent' : true,
                  'key' : '4',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'skilllevel',
                  'index' : false,
                  'artifactId' : 'plannedLabor_skilllevel_spi_wmskilllevel',
                  'id' : 'aw291f4a6c',
                  'persistent' : true,
                  'key' : '5',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'crew',
                  'index' : false,
                  'artifactId' : 'plannedLabor_crew_spi_wmamcrew',
                  'id' : 'aw6f84389',
                  'persistent' : true,
                  'key' : '6',
                  'local' : true,
               ...
               addField({
                  ...
                  'name' : 'amcrewtype',
                  'index' : false,
                  'artifactId' : 'plannedLabor_amcrewtype_spi_wmamcrewtype',
                  'id' : 'aw903884e6',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'status',
                  'index' : false,
                  'artifactId' : 'plannedLabor_status_spi_wmstatus',
                  'id' : 'aw92be82fa',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'scheduledate',
                  'index' : false,
                  'artifactId' : 'plannedLabor_scheduledate_spi_wmscheduledate',
                  'id' : 'aw639a7d38',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'laborhours',
                  'index' : false,
                  'artifactId' : 'plannedLabor_laborhours_spi_wmlaborhrs',
                  'id' : 'awe4612b99',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'vendor',
                  'index' : false,
                  'artifactId' : 'plannedLabor_vendor_spi_wmvendor',
                  'id' : 'aw7d20bd37',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'contractnum',
                  'index' : false,
                  'artifactId' : 'plannedLabor_contractnum_spi_wmcontractnum',
                  'id' : 'awb8b9c19c',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'laborcodeandname',
                  'index' : false,
                  'artifactId' : 'plannedLabor_laborcodeandname_string',
                  'id' : 'awe860fefa',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'crewdesc',
                  'index' : false,
                  'artifactId' : 'plannedLabor_crewdesc_string',
                  'id' : 'aw75f764fc',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'laborCB',
                  'index' : false,
                  'artifactId' : 'plannedLabor_checkbox_boolean',
                  'id' : 'aw8e147de8',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'hours',
                  'index' : false,
                  'artifactId' : 'plannedLabor_hours_spi_wmhours',
                  'id' : 'awac3bd7a0',
                  'persistent' : true,
                  'local' : true,
               });
            ...
            var resource020 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('dcterms:identifier,spi:assetid,spi:orgid,spi:siteid,oslc:shortTitle,dcterms:title,spi:isrunning,spi:status,spi:itemnum,spi:itemtype,spi:itemsetid,spi:parent,spi:description_longdescription,spi:pluscduedate,spi:pluscsolution,spi:updownstatus{spi:changedate}').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
               ...
               addField({
                  ...
                  'name' : 'assetup',
                  'index' : false,
                  'artifactId' : 'additionalasset_assetup_spiisrunning',
                  'id' : 'aw16a02d0e',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'duedate',
                  'index' : false,
                  'artifactId' : 'additionalasset_duedate',
                  'id' : 'aw262b57a3',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'assetsolution',
                  'index' : false,
                  'artifactId' : 'additionalasset_assetsolution',
                  'id' : 'aw59cbbdb4',
                  'local' : false,
            ...
            var resource037 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('dcterms:identifier,oslc:shortTitle,dcterms:title,spi:vendor,spi:orgid,spi:contractnum,spi:worksite,spi:lbsinterval,spi:lbsdatafromwo,spi:lbslaborbased').
               ...
               addField({
                  ...
                  'name' : 'orgid',
                  'index' : false,
                  'artifactId' : 'laborcrew_vendor_spiorgid',
                  'maxSize' : 8,
                  'id' : 'awbe5f3646',
                  'local' : false,
                  'pkIndex' : 1,
               ...
               addField({
                  ...
                  'name' : 'worksite',
                  'index' : false,
                  'artifactId' : 'laborcrew_worksite_spiworksite',
                  'maxSize' : 8,
                  'id' : 'awca3d642e',
                  'local' : false,
                  'remoteName' : 'spi:worksite',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
               ...
               setWhereClause('spi%3Aworksite%3D%24%7Bworksite%7D+and+spi%3Aorgid%3D%24%7Borgid%7D+and+spi%3Avendor%3D%24%7Bvendor%7D+and+spi%3Astatus+in+%5B%24%7Bdomaincrewstatus%5Bmaxvalue%3DACTIVE%5D.value%7D%5D');
            ...
            var resource044 = new ResourceMetadata({
               ...
               setQueryBases([
                     {name:'getclassstructure', queryString:'\/oslc\/os\/oslcclassstructure?savedQuery=pd_anywhereparent', queryLabel:'' }
               ]);
