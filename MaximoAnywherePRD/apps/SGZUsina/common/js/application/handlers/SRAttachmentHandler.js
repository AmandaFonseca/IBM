...
define("application/handlers/SRAttachmentHandler", 
	   [ "dojo/_base/declare",
	     "dojo/_base/lang",
...
/**@memberOf application.handlers.SRAttachmentHandler */
			...
			if (downloadCompleted) {
			    ...
			    ConnectivityChecker.checkConnectivityAvailable().
			        ...
			        if (isConnectionAvailable) {
			            ...
			            self.ui.show('ms_SgzUsina.DownloadAttachmentLocal');
			            self._updatePercentComplete(0);
			            canceled = false;
		...
		initCategory: function(eventContext) {
			var self = this;
			this.setAttachCategoryLookUp('ms_SgzUsina.appDocTypeLookup', 'docType');
			ModelService.allCached('appDocType', 'getSRDocTypes', 50)
