...
// Build: 2022-12-01 21:56:19
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ActionPanel", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ActionPanel", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout ActionPanel ');

            var row = table.insertRow(-1);
            row.className  = 'ActionPanel_row_0';

            var col_button1 = row.insertCell(-1);
            col_button1.className  = 'ActionPanel_button1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ActionPanel_row_1';

            var col_button2 = row.insertCell(-1);
            col_button2.className  = 'ActionPanel_button2_column';
