...
function(declare, all, StoresBuilderBase, ResourceMetadata, PersistenceManager, WorkOrderObject, ClassStructureObject, AttachmentsObject, TaskObject, ActualLaborObject, WoStatusObject, CrewLaborObject, CrewToolObject, MaxDomainObject) {
         ...
         _buildStoresAsync : function(promise) {
            ...
            var resource004 = new ResourceMetadata({
               ...
               setCreationFactories([
                     {name:'createMyAssignedWork', creationString:'\/oslc\/os\/ms_oslcsgztec' }
               ]).
               setQueryBases([
                     {name:'searchAllWorkOrders', queryString:'\/oslc\/os\/ms_oslcsgztec?savedQuery=getWithComplexQuery', defaultForSearch: true, queryLabel:'' },
                     {name:'getMyAssignedWork', queryString:'\/oslc\/os\/ms_oslcsgztec?savedQuery=ms_ControlTec', queryLabel:'' }
               ]);
            var resourcePromise004 = PersistenceManager.initCollection( resource004 );


            var resource005 = new ResourceMetadata({
                  'defaultOrderBy' : 'subitemtc desc',
                  'pageSize' : 1000,
                  'resourceName' : 'wotcorigirec',
                  'isAttachment' : false,
                  'isSystem' : false,
                  'urlBase' : 'https:\/\/smgimax.prefeitura.sp.gov.br:443\/maximo',
                  'inMemory' : false,
                  'artifactId' : 'wotcorigirec',
                  'id' : 'awd9d87904',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('dcterms:identifier,spi_wm:ms_origwo,spi_wm:ms_subitemtc,spi_wm:ms_tcwo,spi_wm:ms_origwoitem,spi_wm:ms_origsite,spi_wm:ms_origaging,spi_wm:ms_origobs,spi_wm:ms_origdesc,spi_wm:ms_origclassstructure,spi_wm:ms_origworktype,spi_wm:ms_origaddr2,spi_wm:ms_origaddr3,spi_wm:ms_origaddrnum,spi_wm:ms_origaddrpost,spi_wm:ms_origcrew,spi_wm:ms_crewcontract,spi_wm:ms_assighrs,spi_wm:ms_assigvendor,spi_wm:ms_assigschdate,spi_wm:ms_tooldesc,spi_wm:ms_toolqty,spi_wm:ms_toolhrs').
               setSupportiveFieldsSelectExpression('spi:attachmentsorig{oslc_cm:attachmentSize,dcterms:title,spi:fileName,dcterms:description,dcterms:created,spi:urlType,spi:docType,spi:printthrulink,spi:contentLocation,spi:anywhererefid,spi:createby}').
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'usage' : 'bigint',
                  'name' : 'identifier',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_identifier_dctermsidentifier',
                  'maxSize' : 19,
                  'id' : 'aw2da9ef76',
                  'local' : false,
                  'remoteName' : 'dcterms:identifier',
               ...
               addField({
                  ...
                  'name' : 'origwo',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigitemid',
                  'maxSize' : 20,
                  'id' : 'aw10da492',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origwo',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'subitemtc',
                  'index' : true,
                  'artifactId' : 'wotcorigrec_spi_wmsubitemtc',
                  'maxSize' : 20,
                  'id' : 'awa4901b82',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_subitemtc',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'integer',
                  ...
                  'name' : 'ctwo',
                  'index' : true,
                  'artifactId' : 'wotcorigrec_spi_wmctwo',
                  'id' : 'aw37081719',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_tcwo',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'origctwoitem',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigwoitem',
                  'maxSize' : 20,
                  'id' : 'awa3a9b105',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origwoitem',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'origsite',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigsite',
                  'maxSize' : 8,
                  'id' : 'aw108c835c',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origsite',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'integer',
                  'name' : 'origaging',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigaging',
                  'id' : 'aw6eecd013',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origaging',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'origobs',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigobs',
                  'maxSize' : 400,
                  'id' : 'aw313f60a5',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origobs',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'origdesc',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigdesc',
                  'maxSize' : 100,
                  'id' : 'aw727a26ec',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origdesc',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'usage' : 'upper',
                  'name' : 'origclassstructure',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigclassstructure',
                  'maxSize' : 20,
                  'id' : 'aw412338a5',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origclassstructure',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'origworktype',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigworktype',
                  'maxSize' : 5,
                  'id' : 'awea04e375',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origworktype',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'origaddr2',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigaddr2',
                  'maxSize' : 255,
                  'id' : 'aw89f71488',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origaddr2',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'origaddr3',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigaddr3',
                  'maxSize' : 255,
                  'id' : 'awfef0241e',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origaddr3',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'origaddrnum',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigaddrnum',
                  'maxSize' : 9,
                  'id' : 'awacb41ab4',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origaddrnum',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'origaddrpost',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigaddrpost',
                  'maxSize' : 12,
                  'id' : 'aw3cfca0f2',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origaddrpost',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'origcrew',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmorigcrew',
                  'maxSize' : 8,
                  'id' : 'awf086ca0a',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_origcrew',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'crewcontract',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmcrewcontract',
                  'maxSize' : 8,
                  'id' : 'awba63d1d',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_crewcontract',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'double',
                  ...
                  'index' : false,
                  'scale' : 0,
                  'artifactId' : 'wotcorigrec_spi_wmassighrs',
                  'id' : 'awc23bbd6e',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_assighrs',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'assigvendor',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmassigvendor',
                  'maxSize' : 25,
                  'id' : 'aw7b7a594',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_assigvendor',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'datetime',
                  'name' : 'assigschdate',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmassigschdate',
                  'id' : 'aw4f5a2934',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_assigschdate',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'tooldesc',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spi_wmtooldesc',
                  'maxSize' : 100,
                  'id' : 'awf42b2493',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_tooldesc',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'double',
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'wotcorigrec_spi_wmtoolqty',
                  'id' : 'aw591a19c6',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_toolqty',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'double',
                  ...
                  'index' : false,
                  'scale' : 0,
                  'artifactId' : 'wotcorigrec_spi_wmtoolhrs',
                  'id' : 'awfc62cfa1',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_toolhrs',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
                  'referenceResource' : 'attachmentsOrig',
                  'name' : 'attachmentsorig',
                  'index' : false,
                  'artifactId' : 'wotcorigrec_spiattachments',
                  'id' : 'aw50e249b4',
                  'describedByResource' : 'attachmentsOrig',
                  'local' : false,
                  'remoteName' : 'spi:attachmentsorig',
                  'selectExpression' : 'spi:attachmentsorig{oslc_cm:attachmentSize,dcterms:title,spi:fileName,dcterms:description,dcterms:created,spi:urlType,spi:docType,spi:printthrulink,spi:contentLocation,spi:anywhererefid,spi:createby}',
               }).
               setQueryBases([
                     {name:'getoslcwotcorig', queryString:'\/oslc\/os\/ms_oslcwotcorigi?savedQuery=MS_ORIGITENS', queryLabel:'' }
               ]);
            ...
            var resource006 = new ResourceMetadata({
                  'defaultOrderBy' : 'wonum asc',
                  'pageSize' : 1000,
                  'resourceName' : 'origattachment',
                  'isAttachment' : false,
                  'isSystem' : false,
                  'urlBase' : 'https:\/\/smgimax.prefeitura.sp.gov.br:443\/maximo',
                  'inMemory' : false,
                  'artifactId' : 'origattachment',
                  'id' : 'aw879bef38',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('dcterms:identifier,oslc:shortTitle').
               ...
               addField({
                  ...
                  'name' : 'identifier',
                  'index' : true,
                  'artifactId' : 'origattachment_identifier_dctermsidentifier',
                  'maxSize' : 19,
                  'id' : 'awd220b515',
                  'local' : false,
                  'remoteName' : 'dcterms:identifier',
               ...
               addField({
                  ...
                  'name' : 'wonum',
                  'index' : true,
                  'artifactId' : 'origattachment_wonum_oslcshortTitle',
                  'maxSize' : 20,
                  'id' : 'aw90b4e5c5',
                  'local' : false,
                  'pkIndex' : 2,
               ...
               addField({
                  ...
                  'name' : 'attachmentsorig',
                  'index' : false,
                  'artifactId' : 'origattachment_spiattachments',
                  'id' : 'aw56fd09b',
                  'describedByResource' : 'attachments',
                  'local' : false,
                  'remoteName' : 'spi:attachments',
               ...
               setQueryBases([
                     {name:'getOriginalAttach', queryString:'\/oslc\/os\/ms_oslcorigattach?savedQuery=ms_sgztecOrig', queryLabel:'' }
               ]);
            ...
            var resource013 = new ResourceMetadata({
                  'pageSize' : 1000,
                  'resourceName' : 'attachmentsOrig',
                  'isAttachment' : true,
                  'isSystem' : false,
                  'inMemory' : false,
                  'artifactId' : 'attachmentsOrig',
                  'id' : 'aw2eedd966',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               addField({
                  ...
                  'name' : 'fileSize',
                  'index' : false,
                  'artifactId' : 'attachments_orig__fileSize_oslc_cmattachmentSize',
                  'id' : 'awdd3958af',
                  'local' : false,
                  'remoteName' : 'oslc_cm:attachmentSize',
               }).
               addField({
                  ...
                  'name' : 'fileName',
                  'index' : false,
                  'artifactId' : 'attachments_orig__fileName_dctermstitle',
                  'id' : 'awb455c579',
                  'key' : '1',
                  'local' : false,
                  'remoteName' : 'dcterms:title',
               ...
               addField({
                  ...
                  'name' : 'fullFileName',
                  'index' : false,
                  'artifactId' : 'attachments_orig__fullFileName_spifileName',
                  'id' : 'awcb30ba43',
                  'key' : '2',
                  'local' : false,
                  'remoteName' : 'spi:fileName',
               ...
               addField({
                  ...
                  'name' : 'description',
                  'index' : false,
                  'artifactId' : 'attachments_orig__description_dctermsdescription',
                  'id' : 'awcce9d13e',
                  'local' : false,
                  'remoteName' : 'dcterms:description',
               }).
               addField({
                  ...
                  'name' : 'creationDate',
                  'index' : false,
                  'artifactId' : 'attachments_orig__creationDate_dctermscreated',
                  'id' : 'aw9bc09b7a',
                  'key' : '3',
                  'local' : false,
                  'remoteName' : 'dcterms:created',
               ...
               addField({
                  ...
                  'name' : 'urlType',
                  'index' : false,
                  'artifactId' : 'attachments_orig__urlType_spiurlType',
                  'id' : 'aw26856309',
                  'local' : false,
                  'remoteName' : 'spi:urlType',
               }).
               addField({
                  ...
                  'name' : 'docType',
                  'index' : false,
                  'artifactId' : 'attachments_orig__docType_spidocType',
                  'id' : 'aw90c0c54b',
                  'local' : false,
                  'remoteName' : 'spi:docType',
               }).
               addField({
                  ...
                  'name' : 'bulkDownload',
                  'index' : false,
                  'artifactId' : 'attachments_orig__bulkDownload_spiprintthrulink',
                  'id' : 'aw9ffd6553',
                  'local' : false,
                  'remoteName' : 'spi:printthrulink',
               }).
               addField({
                  ...
                  'name' : 'contentLocation',
                  'index' : false,
                  'artifactId' : 'attachments_orig__contentLocation_spicontentLocation',
                  'id' : 'aw9bbc6501',
                  'local' : false,
                  'remoteName' : 'spi:contentLocation',
               }).
               addField({
                  ...
                  'name' : 'anywhereRefId',
                  'index' : false,
                  'artifactId' : 'attachments_orig__anywhereRefId_spianywhererefid',
                  'id' : 'awc774d471',
                  'local' : false,
                  'remoteName' : 'spi:anywhererefid',
               }).
               addField({
                  ...
                  'name' : 'createby',
                  'index' : false,
                  'artifactId' : 'attachments_orig__createby_spicreateby',
                  'id' : 'awe143e90a',
                  'local' : false,
                  'remoteName' : 'spi:createby',
               }).
               addField({
                  ...
                  'name' : 'displaySize',
                  'index' : false,
                  'artifactId' : 'attachments_orig__displaySize_string',
                  'id' : 'aw66ff38f',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'category',
                  'index' : true,
                  'artifactId' : 'attachments_orig__category_string',
                  'id' : 'aw908c25d3',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'section',
                  'index' : true,
                  'artifactId' : 'attachments_orig__section_string',
                  'id' : 'awd5da47ce',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'formula' : '(${fileName} || ${anywhereAttachName})',
                  'index' : false,
                  'artifactId' : 'attachments_orig__displayFileName_string',
                  'id' : 'aw8ce0feb5',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'formula' : '(${description} || ${anywhereAttachDescription})',
                  'index' : false,
                  'artifactId' : 'attachments_orig__displayDescription_string',
                  'id' : 'aw689c9ec',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'formula' : '(${docType} || ${anywhereAttachCategory})',
                  'index' : false,
                  'artifactId' : 'attachments_orig__displayCategory_string',
                  'id' : 'awd94f039a',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'formula' : '(${creationDate} || ${anywhereCreationDate})',
                  'index' : false,
                  'artifactId' : 'attachments_orig__displayCreationDate_dateTime',
                  'id' : 'awd1b9cd67',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'formula' : '${displayCreationDate}',
                  'index' : true,
                  'artifactId' : 'attachments_orig__displayCreationDate_dateTime_ISO',
                  'id' : 'aw41c1192b',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'displayFileType',
                  'index' : false,
                  'artifactId' : 'attachments_orig__displayFileType_string',
                  'id' : 'awa94f06c0',
                  'persistent' : true,
                  'local' : true,
               });
            ...
            var resource050 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('dcterms:identifier,spi:siteid,spi:active,spi:dorollover,spi:rollover,spi:isdelta,spi:inspector,spi:newreading,spi:newreadingdate,spi:readingtype,spi:lastreading,spi:lastreadingdate,spi:remarks,spi:meter{spi:domainid,dcterms:title,spi:metertype,oslc:shortTitle},spi:asset{dcterms:title}').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
