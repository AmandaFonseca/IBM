...
/**@memberOf application.handlers.CommonHandler */
		...
		_getServiceRequestSiteId : function(self) {
			if(this._getAdditionalResource(self, 'serviceRequest').getCurrentRecord() != null){
				return this._getAdditionalResource(self, 'serviceRequest').getCurrentRecord().get('siteid');
			}
			else{
				return null;
			}
