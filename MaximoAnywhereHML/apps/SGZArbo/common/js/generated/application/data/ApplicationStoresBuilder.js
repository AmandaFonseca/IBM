      ...
      return declare("generated.application.data.ApplicationStoresBuilder", StoresBuilderBase, {
         ...
         _buildStoresAsync : function(promise) {
            ...
            var resource004 = new ResourceMetadata({
               ...
               setQueryBases([
                     {name:'searchAllAssets', queryString:'\/oslc\/os\/ms_oslcsgzarbo?savedQuery=MS_allTrees', defaultForSearch: true, queryLabel:'' },
            ...
            var resource006 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('spi:ms_target,spi:ms_angle,spi:ms_arboid,spi:ms_assetnum,spi:ms_changeby,spi:ms_changedate,spi:ms_diameter,spi:ms_diameterbreast,spi:ms_diametercolon,spi:ms_direction,spi:ms_family,spi:ms_firstbranch,spi:ms_genre,spi:ms_inadequatesite,spi:ms_jammvegetation,spi:ms_length,spi:ms_liftingfloor,spi:ms_locpublic,spi:ms_loctree,spi:ms_perimeterbreast,spi:ms_perimetercolon,spi:ms_permeablearea,spi:ms_popularname,spi:ms_remarks,spi:ms_retreat,spi:ms_ridewidth,spi:ms_scientific,spi:ms_slope,spi:ms_species,spi:ms_speciesunident,spi:ms_treeheight,spi:ms_typebuild,spi:ms_width').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  'name' : 'ms_target',
                  'index' : false,
                  'artifactId' : 'asset_ms_arbo_spims_arboms_target',
                  'maxSize' : 20,
                  'id' : 'awf07c5f79',
                  'local' : false,
                  'remoteName' : 'spi:ms_target',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'double',
               ...
               addField({
                  ...
                  'name' : 'ms_remarks',
                  'index' : false,
                  'artifactId' : 'asset_ms_arbo_spims_arboms_ms_remarks',
                  'maxSize' : 255,
                  'id' : 'aw96a6d21b',
                  'local' : false,
                  'remoteName' : 'spi:ms_remarks',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'boolean',
               ...
               addField({
                  ...
                  'name' : 'np_targetdesc',
                  'index' : false,
                  'artifactId' : 'asset_ms_arbo_spims_arbo_np_targetdesc',
                  'id' : 'aw8775ee7e',
                  'persistent' : true,
                  'local' : true,
               });
            ...
            var resource007 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('spi:ms_description,spi:ms_target,dcterms:identifier').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'dataType' : 'string',
                  'name' : 'ms_description',
                  'index' : false,
                  'artifactId' : 'mstarget_ms_description',
                  'id' : 'aw64170762',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_targetid',
                  'index' : false,
                  'artifactId' : 'mstarget_ms_targetid',
                  'id' : 'aw24a87db4',
                  'local' : false,
                  'remoteName' : 'dcterms:identifier',
               }).
               setQueryBases([
                     {name:'gettarget', queryString:'\/oslc\/os\/ms_oslctarget', queryLabel:'' }
               ]);
