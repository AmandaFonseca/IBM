...
function(declare, all, StoresBuilderBase, ResourceMetadata, PersistenceManager, WorkOrderObject, AssignmentObject, PlannedMaterialObject, PlannedToolObject, ClassStructureObject, AttachmentsObject, TaskObject, ActualLaborObject, WoStatusObject, CrewLaborObject, CrewToolObject, MaxDomainObject) {
         ...
         _buildStoresAsync : function(promise) {
            ...
            var resource004 = new ResourceMetadata({
               ...
               addField({
                  ...
                  'selectExpression' : 'spi_wm:wpmaterial{spi_wm:wpitemid,spi_wm:taskid,spi_wm:itemnum,spi_wm:description,spi_wm:description_longdescription,spi_wm:itemqty,spi_wm:linetype,spi_wm:directreq,spi_wm:itemsetid,spi_wm:storelocsite,spi_wm:requestnum}',
               }).
               addField({
                  'multiplicity' : 'zero-or-many',
                  'dataType' : 'inline',
