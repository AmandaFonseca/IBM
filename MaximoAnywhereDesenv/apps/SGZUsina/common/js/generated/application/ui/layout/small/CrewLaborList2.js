...
// Build: 2023-05-18 19:51:10
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/CrewLaborList2", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.CrewLaborList2", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout CrewLaborList2 ');

            var row = table.insertRow(-1);
            row.className  = 'CrewLaborList2_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'CrewLaborList2_item1_column';
            col_item1.colSpan = '4';
            ...
            col_item2.className  = 'CrewLaborList2_item2_column';
            col_item2.colSpan = '8';
            ...
            var row = table.insertRow(-1);
            row.className  = 'CrewLaborList2_row_1';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'CrewLaborList2_item5_column';
            col_item5.colSpan = '4';
            ...
            col_item4.className  = 'CrewLaborList2_item4_column';
            col_item4.colSpan = '6';
            ...
            col_item3.className  = 'CrewLaborList2_item3_column';
            col_item3.colSpan = '2';
            ...
            var row = table.insertRow(-1);
            row.className  = 'CrewLaborList2_row_2';

            var col_button1 = row.insertCell(-1);
            col_button1.className  = 'CrewLaborList2_button1_column';
            ...
            col_button2.className  = 'CrewLaborList2_button2_column';
