...
define({
         ...
         "v7.6.4:1006221346D" : "[onbepaalde~v7.6.4:1006221346D]",
         "Lista Padr\u00E3o" : "[onbepaalde~Lista Padrão]",
         "Synchronize Data" : "[onbepaalde~Synchronize Data]",
         "Gerar Novo Ticket" : "[onbepaalde~Gerar Novo Ticket]",
         "Minha Lista de Tickets" : "[onbepaalde~Minha Lista de Tickets]",
         "My Reported SRs" : "[onbepaalde~My Reported SRs]",
         "Meus Tickets" : "[onbepaalde~Meus Tickets]",
         "Records with Errors" : "[onbepaalde~Records with Errors]",
         "Request Number" : "[onbepaalde~Request Number]",
         "Completar Carregamento" : "[onbepaalde~Completar Carregamento]",
         "Ticket" : "[onbepaalde~Ticket]",
         "Usina" : "[onbepaalde~Usina]",
         "Usina Autorizada" : "[onbepaalde~Usina Autorizada]",
         "Subprefeitura" : "[onbepaalde~Subprefeitura]",
         "Status" : "[onbepaalde~Status]",
         "Data de Validade" : "[onbepaalde~Data de Validade]",
         "Contratada" : "[onbepaalde~Contratada]",
         "Placa" : "[onbepaalde~Placa]",
         "Quantidade de Massa Asf\u00E1ltica (kg)" : "[onbepaalde~Quantidade de Massa Asfáltica (kg)]",
         "Observa\u00E7\u00F5es" : "[onbepaalde~Observações]",
         "Peso Tara (kg)" : "[onbepaalde~Peso Tara (kg)]",
         "Peso L\u00EDquido (kg)" : "[onbepaalde~Peso Líquido (kg)]",
         "Quantidade de Massa Asf\u00E1ltica Carregada (kg)" : "[onbepaalde~Quantidade de Massa Asfáltica Carregada (kg)]",
         "Quantidade de Emuls\u00E3o Carregada (kg)" : "[onbepaalde~Quantidade de Emulsão Carregada (kg)]",
         "Peso Bruto (Kg)" : "[onbepaalde~Peso Bruto (Kg)]",
         "Foto Ticket de Carregamento" : "[onbepaalde~Foto Ticket de Carregamento]",
         "Cancel" : "[onbepaalde~Cancel]",
         "Salvar" : "[onbepaalde~Salvar]",
         "Finalizar" : "[onbepaalde~Finalizar]",
         "Transferir para outra Usina" : "[onbepaalde~Transferir para outra Usina]",
         "Complet Carreg: Usina Crendenciada" : "[onbepaalde~Complet Carreg: Usina Crendenciada]",
         "Tap to enter" : "[onbepaalde~Tap to enter]",
         "Gerar Ticket" : "[onbepaalde~Gerar Ticket]",
         "Foto Placa" : "[onbepaalde~Foto Placa]",
         "Create" : "[onbepaalde~Create]",
         "Detalhes do Ticket Aguardando Carregamento" : "[onbepaalde~Detalhes do Ticket Aguardando Carregamento]",
         "Quantidade de Massa Asf\u00E1ltica (Kg)" : "[onbepaalde~Quantidade de Massa Asfáltica (Kg)]",
         "Peso Tara (Kg)" : "[onbepaalde~Peso Tara (Kg)]",
         "Peso L\u00EDquido (Kg)" : "[onbepaalde~Peso Líquido (Kg)]",
         "Quantidade de Massa Asf\u00E1ltica Carregada (Kg)" : "[onbepaalde~Quantidade de Massa Asfáltica Carregada (Kg)]",
         "Quantidade de Emuls\u00E3o Carregada (Kg)" : "[onbepaalde~Quantidade de Emulsão Carregada (Kg)]",
         "Detalhes do Ticket" : "[onbepaalde~Detalhes do Ticket]",
         "tura" : "[onbepaalde~tura]",
         ...
         "Yes" : "[onbepaalde~Yes]",
         "No" : "[onbepaalde~No]",
         "Tem certeza que deseja finalizar o ticket?" : "[onbepaalde~Tem certeza que deseja finalizar o ticket?]",
         "O carregamento desse ticket est\u00E1 completo?" : "[onbepaalde~O carregamento desse ticket está completo?]",
         "Select Value" : "[onbepaalde~Select Value]",
         "Selecione" : "[onbepaalde~Selecione]",
         "Selecione Usina Credenciada" : "[onbepaalde~Selecione Usina Credenciada]",
         "Selecione Site" : "[onbepaalde~Selecione Site]",
         ...
         "applicationName" : "[onbepaalde~Maximo Anywhere Usina de Asfalto]",
         ...
         "veiculoinvalido" : "[onbepaalde~Veiculo Não Autorizado.]",
         "qtdAuthqty" : "[onbepaalde~Quantidade não Autorizada.]",
         "semanexo" : "[onbepaalde~Por Favor! Tire a Foto da Placa do Veículo.]",
         ...
         "nolookupdata" : "[onbepaalde~No lookup data is stored on the device. Download lookup data from the Settings screen.]",
