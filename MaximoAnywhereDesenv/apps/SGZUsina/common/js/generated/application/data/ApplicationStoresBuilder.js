         ...
         _buildStoresAsync : function(promise) {
            ...
            var resource004 = new ResourceMetadata({
               ...
               addField({
                  ...
                  'name' : 'ms_plate',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_plate',
                  'maxSize' : 8,
                  'id' : 'aw4e83681',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_remarks',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_remarks',
                  'maxSize' : 256,
                  'id' : 'awe83007d6',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_itemnum',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_itemnum',
                  'maxSize' : 30,
                  'id' : 'aw4b7b20d',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_company',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_company',
                  'maxSize' : 25,
                  'id' : 'awe3658342',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_ms_authqty',
                  'id' : 'aw82e160be',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_changeby',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_changeby',
                  'maxSize' : 30,
                  'id' : 'aw8e57cf9b',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_changedate',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_changedate',
                  'id' : 'aw99629469',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_ms_rembal1',
                  'id' : 'aw3376036a',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_rembal1',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'double',
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_ms_rembal2',
                  'id' : 'awaa7f52d0',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_rembal2',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'ms_enterby',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_enterby',
                  'maxSize' : 30,
                  'id' : 'awf30b65a6',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_refdate',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_refdate',
                  'id' : 'aw8fd06013',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_qtd_massa',
                  'id' : 'aw4a149116',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_asphaltmixqty',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'double',
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_qtd_emulsao',
                  'id' : 'awa71723aa',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_emulsionqty',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'datetime',
                  ...
                  'name' : 'ms_expiredate',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_expiredate',
                  'id' : 'aw1e113a4c',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_authdate',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_authdate',
                  'id' : 'awb05bdca',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_status',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_status',
                  'maxSize' : 10,
                  'id' : 'aw1d732837',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_actualdate',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_ms_actualdate',
                  'id' : 'awf94bdc4c',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_siteid',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_siteid',
                  'maxSize' : 8,
                  'id' : 'aw9a84cd74',
                  'local' : false,
               ...
               addField({
                  ...
                  'dataType' : 'integer',
                  'usage' : 'bigint',
                  'name' : 'ms_asphaltplantid',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_asphaltplantid',
                  'id' : 'awfe8b9010',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_asphaltplantid',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'integer',
                  ...
                  'name' : 'ms_apidauth',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_apidauth',
                  'id' : 'aw71c5e90a',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_apidauth',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'boolean',
                  'name' : 'ms_isapauth',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_isapauth',
                  'id' : 'aweafb5b0d',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_isapauth',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'integer',
                  ...
                  'name' : 'ms_amtkidauth',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_amtkidauth',
                  'id' : 'awe449de10',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_amtkidauth',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'double',
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_ms_tareweight',
                  'id' : 'aw797601ca',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_ms_grossweight',
                  'id' : 'aw9021057d',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'serviceRequest_ms_netweight',
                  'id' : 'awfc485834',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_contractnum',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_contractnum',
                  'maxSize' : 8,
                  'id' : 'aw250b0e7e',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'scale' : 10,
                  'artifactId' : 'serviceRequest_mslatitudey_spi_wmcalculatedy',
                  'id' : 'aweb3e43fb',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'scale' : 10,
                  'artifactId' : 'serviceRequest_mslongitudex_spi_wmcalculatedx',
                  'id' : 'awb347553f',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_latitudestr',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_latitudestr',
                  'maxSize' : 100,
                  'id' : 'aw5795b3d4',
                  'local' : false,
               ...
               addField({
                  ...
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_longitudestr',
                  'maxSize' : 100,
                  'id' : 'awd59cf3d6',
                  'local' : false,
               ...
               addField({
                  ...
                  'dataType' : 'string',
                  'usage' : 'upper',
                  'name' : 'ms_amtkidauthstr',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_amtkidauthstr',
                  'maxSize' : 30,
                  'id' : 'aw503311c8',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_amtkidauthstr',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'boolean',
                  'name' : 'ms_isauth',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_isauth',
                  'id' : 'aw9fa24740',
                  'local' : false,
               ...
               addField({
                  ...
                  'dataType' : 'inline',
                  'referenceResource' : 'sgzUsina',
                  'name' : 'usina',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_itemnum_spi_wm_ms_description',
                  'maxSize' : 256,
                  'id' : 'awe75a0756',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_asphaltplant',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi_wm:ms_active',
                  'dataType' : 'inline',
                  'referenceResource' : 'sgzUsina',
                  'name' : 'ms_active',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_itemnum_spi_wm_ms_active',
                  'id' : 'awa2b0d478',
                  'local' : false,
                  'remoteName' : 'spi_wm:ms_asphaltplant',
               }).
               addField({
                  ...
                  'name' : 'usinadesc',
                  'index' : false,
                  'artifactId' : 'serviceRequest_usinadesc_string',
                  'id' : 'awea9da05e',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'sitedesc',
                  'index' : false,
                  'artifactId' : 'serviceRequest_sitedesc_string',
                  'id' : 'awc0b76193',
                  'persistent' : true,
                  'local' : true,
               }).
               addField({
                  ...
                  'name' : 'contratada',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_itemnum_spi_wm_contratada',
                  'maxSize' : 150,
                  'id' : 'aw5cfc54ff',
                  'local' : false,
               ...
               addField({
                  'multiplicity' : 'exactly-one',
                  'displayValueRemoteName' : 'spi_wm:company',
                  'dataType' : 'inline',
                  'usage' : 'upper',
                  'referenceResource' : 'sgzUsina',
                  'name' : 'company',
                  'index' : false,
                  'artifactId' : 'serviceRequest_ms_itemnum_spi_wm_company',
                  'maxSize' : 25,
                  'id' : 'aw744a9688',
                  'local' : false,
                  'remoteName' : 'spi_wm:companies',
               ...
               setCreationFactories([
                     {name:'createSR', creationString:'\/oslc\/os\/ms_oslcsgzusina' }
               ]).
               setQueryBases([
                     {name:'ConsultaPadraoSGZUsina', queryString:'\/oslc\/os\/ms_oslcsgzusina?savedQuery=MS_AMTK%3AConsultaPadraoSGZUsina', queryLabel:'' }
               ]);
            ...
            var resource010 = new ResourceMetadata({
                  'pageSize' : 10,
                  'resourceName' : 'MSaptoolauth',
                  'isAttachment' : false,
                  'isSystem' : true,
                  'urlBase' : 'http:\/\/35.199.113.215:80\/maximo',
                  'inMemory' : false,
                  'artifactId' : 'MSaptoolauth',
                  'id' : 'awd3dd8c2f',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('spi:ms_plate,spi:ms_itemnum,dcterms:identifier,spi:ms_active,spi:ms_asphaltplantid,spi:ms_company,spi:ms_loadcapacity,spi:ms_startdate,spi:ms_enddate,spi:ms_shiftnum').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'ms_plate',
                  'index' : true,
                  'artifactId' : 'ms_aptoolauth_ms_plate_spi',
                  'maxSize' : 8,
                  'id' : 'awfd23acb5',
                  'local' : false,
                  'remoteName' : 'spi:ms_plate',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'ms_itemnum',
                  'index' : true,
                  'artifactId' : 'ms_aptoolauth_ms_plate_spims_itemnum',
                  'maxSize' : 30,
                  'id' : 'awafa5119b',
                  'local' : false,
                  'remoteName' : 'spi:ms_itemnum',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'identifier',
                  'index' : true,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_dctermsidentifier',
                  'maxSize' : 19,
                  'id' : 'aw107820f5',
                  'local' : false,
                  'pkIndex' : 1,
               ...
               addField({
                  ...
                  'name' : 'ms_active',
                  'index' : false,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_ms_active',
                  'id' : 'aw90bf4f14',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_asphaltplantid',
                  'index' : false,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_ms_asphaltplantid',
                  'id' : 'aw63a3e6b9',
                  'local' : false,
                  'remoteName' : 'spi:ms_asphaltplantid',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'ms_company',
                  'index' : false,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_ms_company',
                  'maxSize' : 25,
                  'id' : 'awbbb01dad',
                  'local' : false,
                  'remoteName' : 'spi:ms_company',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'double',
                  'name' : 'ms_loadcapacity',
                  'index' : false,
                  'scale' : 2,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_ms_loadcapacity',
                  'id' : 'aw8c226310',
                  'local' : false,
                  'remoteName' : 'spi:ms_loadcapacity',
               }).
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'datetime',
                  ...
                  'name' : 'ms_startdate',
                  'index' : false,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_ms_startdate',
                  'id' : 'aw9d0c803a',
                  'local' : false,
                  'remoteName' : 'spi:ms_startdate',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'datetime',
                  ...
                  'name' : 'ms_enddate',
                  'index' : false,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_ms_enddate',
                  'id' : 'aw657bff1f',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_shiftnum',
                  'index' : false,
                  'artifactId' : 'ms_aptoolauth_ms_aptoolauthid_ms_shiftnum',
                  'maxSize' : 50,
                  'id' : 'aw4f825a10',
                  'local' : false,
                  'remoteName' : 'spi:ms_shiftnum',
               }).
               setQueryBases([
                     {name:'getms_aptoolauth', queryString:'\/oslc\/os\/ms_oslcaptoolauth?savedQuery=MS_Veiculo_Ativo', queryLabel:'' }
               ]);
            ...
            var resource011 = new ResourceMetadata({
                  'pageSize' : 10,
                  'resourceName' : 'MSasphaltplant',
                  'isAttachment' : false,
                  'isSystem' : true,
                  'urlBase' : 'http:\/\/35.199.113.215:80\/maximo',
                  'inMemory' : false,
                  'artifactId' : 'MSasphaltplant',
                  'id' : 'awfbb8246f',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('spi:ms_asphaltplantid,spi:ms_active,spi:ms_description').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'integer',
                  ...
                  'name' : 'idusina',
                  'index' : true,
                  'artifactId' : 'ms_asphaltPlant_MSasphaltplant_dctermsidentifier',
                  'id' : 'aw64d5efc9',
                  'local' : false,
                  'pkIndex' : 1,
                  'remoteName' : 'spi:ms_asphaltplantid',
               ...
               addField({
                  ...
                  'name' : 'active',
                  'index' : false,
                  'artifactId' : 'ms_asphaltPlant_MSasphaltplant_ms_active',
                  'id' : 'aw8936d421',
                  'local' : false,
                  'remoteName' : 'spi:ms_active',
               }).
               addField({
                  ...
                  'name' : 'description',
                  'index' : false,
                  'artifactId' : 'ms_asphaltPlant_MSasphaltplant_ms_description',
                  'maxSize' : 256,
                  'id' : 'aw419130b7',
                  'local' : false,
                  'remoteName' : 'spi:ms_description',
               }).
               setQueryBases([
                     {name:'getms_asphaltplant', queryString:'\/oslc\/os\/ms_oslcasphaltplant?savedQuery=ms_usinaperson', queryLabel:'' }
               ]);
            ...
            var resource012 = new ResourceMetadata({
                  'pageSize' : 10,
                  'resourceName' : 'MSasphaltTransf',
                  'isAttachment' : false,
                  'isSystem' : true,
                  'urlBase' : 'http:\/\/35.199.113.215:80\/maximo',
                  'inMemory' : false,
                  'artifactId' : 'MSasphaltTransf',
                  'id' : 'awa7891709',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               addField({
                  ...
                  'name' : 'idusina',
                  'index' : true,
                  'artifactId' : 'ms_asphaltPlant_MSasphaltTransf',
                  'id' : 'awe44f3bd2',
                  'local' : false,
                  'pkIndex' : 1,
                  'remoteName' : 'spi:ms_asphaltplantid',
               ...
               addField({
                  ...
                  'name' : 'active',
                  'index' : false,
                  'artifactId' : 'ms_asphaltPlant_MSasphaltTransf_ms_active',
                  'id' : 'awfbf5d2f2',
                  'local' : false,
                  'remoteName' : 'spi:ms_active',
               }).
               addField({
                  ...
                  'name' : 'description',
                  'index' : false,
                  'artifactId' : 'ms_asphaltPlant_MSasphaltTransf_ms_description',
                  'maxSize' : 256,
                  'id' : 'aw244f598f',
                  'local' : false,
                  'remoteName' : 'spi:ms_description',
               ...
               setQueryBases([
                     {name:'getms_MSasphaltTransf', queryString:'\/oslc\/os\/ms_oslcasphaltplant?savedQuery=ms_usinapersonTranf', queryLabel:'' }
               ]);
            ...
            var resource013 = new ResourceMetadata({
                  'pageSize' : 10,
                  'resourceName' : 'MSPersonAut',
                  'isAttachment' : false,
                  'isSystem' : true,
                  'urlBase' : 'http:\/\/35.199.113.215:80\/maximo',
                  'inMemory' : false,
                  'artifactId' : 'MSPersonAut',
                  'id' : 'aw8c833646',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('spi:personid,spi:status').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'personid',
                  'index' : true,
                  'artifactId' : 'ms_oslcpersonaut_MSPersonAut_dctermsidentifier',
                  'maxSize' : 30,
                  'id' : 'awe13209e7',
                  'local' : false,
                  'pkIndex' : 1,
               ...
               addField({
                  ...
                  'name' : 'status',
                  'index' : false,
                  'artifactId' : 'ms_oslcpersonaut_MSPersonAut_status',
                  'maxSize' : 12,
                  'id' : 'aw650c862e',
                  'local' : false,
                  'remoteName' : 'spi:status',
               ...
               setQueryBases([
                     {name:'getms_personaut', queryString:'\/oslc\/os\/ms_oslcauthperson?savedQuery=ms_personauth', queryLabel:'' }
               ]);
            ...
            var resource014 = new ResourceMetadata({
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('spi:siteid,spi:orgid,spi:description').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'exactly-one',
                  'dataType' : 'string',
               ...
               addField({
                  ...
                  'name' : 'description',
                  'index' : false,
                  'artifactId' : 'mms_site_description',
                  'maxSize' : 100,
                  'id' : 'awf2dd58b',
                  'local' : false,
               ...
               setQueryBases([
                     {name:'getms_msoslcsite', queryString:'\/oslc\/os\/ms_oslcsite?savedQuery=ms_siteveiculo', queryLabel:'' }
               ]);
            ...
            var resource015 = new ResourceMetadata({
                  'pageSize' : 10,
                  'resourceName' : 'toolsiteauth',
                  'isAttachment' : false,
                  'isSystem' : true,
                  'urlBase' : 'http:\/\/35.199.113.215:80\/maximo',
                  'inMemory' : false,
                  'artifactId' : 'toolsiteauth',
                  'id' : 'aw210474bd',
                  'additionalData' : false,
                  'adapterName' : 'OSLCGenericAdapter',
                  'maxFetchDataLimit' : 0,
               ...
               setLocal( false ).
               setSimpleFieldsSelectExpression('dcterms:identifier,spi:ms_siteid,spi:ms_contractnum,spi:ms_plate,spi:ms_itemnum,spi:ms_status,spi:ms_asphaltplantid').
               setSupportiveFieldsSelectExpression('').
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'string',
                  ...
                  'name' : 'identifier',
                  'index' : true,
                  'artifactId' : 'toolsiteauth_identifier',
                  'maxSize' : 19,
                  'id' : 'aw17e856b0',
                  'local' : false,
                  'pkIndex' : 1,
               ...
               addField({
                  ...
                  'name' : 'ms_siteid',
                  'index' : false,
                  'artifactId' : 'toolsiteauth_siteid',
                  'maxSize' : 8,
                  'id' : 'aw39db68f0',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_contractnum',
                  'index' : false,
                  'artifactId' : 'toolsiteauth_ms_contractnum',
                  'maxSize' : 8,
                  'id' : 'aw4507d77b',
                  'local' : false,
               ...
               addField({
                  ...
                  'name' : 'ms_itemnum',
                  'index' : true,
                  'artifactId' : 'toolsiteauth_ms_itemnum',
                  'maxSize' : 30,
                  'id' : 'awd77ccb68',
                  'local' : false,
                  'remoteName' : 'spi:ms_itemnum',
               ...
               addField({
                  ...
                  'name' : 'ms_status',
                  'index' : false,
                  'artifactId' : 'toolsiteauth_ms_status',
                  'maxSize' : 12,
                  'id' : 'awfeb650',
                  'local' : false,
                  'remoteName' : 'spi:ms_status',
               }).
               addField({
                  'multiplicity' : 'zero-or-one',
                  'dataType' : 'integer',
                  ...
                  'name' : 'ms_asphaltplantid',
                  'index' : false,
                  'artifactId' : 'toolsiteauth_ms_asphaltplantid',
                  'id' : 'awa10c60e6',
                  'local' : false,
                  'remoteName' : 'spi:ms_asphaltplantid',
               }).
               setQueryBases([
                     {name:'getms_toolsiteauth', queryString:'\/oslc\/os\/ms_oslctoolsiteauth', queryLabel:'' }
               ]);
