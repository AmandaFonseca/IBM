...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.WorkListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            var row = table.insertRow(-1);
            row.className  = 'WorkListItem_row_3';
            ...
            col_item7.className  = 'WorkListItem_item7_column';
            col_item7.colSpan = '5';
            ...
            var row = table.insertRow(-1);
            row.className  = 'WorkListItem_row_4';

            var col_item8 = row.insertCell(-1);
            col_item8.className  = 'WorkListItem_item8_column';
            col_item8.colSpan = '5';
            ...
            col_item9.className  = 'WorkListItem_item9_column';
            col_item9.colSpan = '5';
