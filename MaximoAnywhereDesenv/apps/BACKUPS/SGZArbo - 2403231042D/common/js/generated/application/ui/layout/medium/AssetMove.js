...
// Build: 2023-01-12 11:59:20
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/medium/AssetMove", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.medium.AssetMove", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            var row = table.insertRow(-1);
            row.className  = 'AssetMove_row_0_2';
            ...
            var row = table.insertRow(-1);
            row.className  = 'AssetMove_row_1_2';
