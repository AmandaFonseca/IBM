...
//			var assetLoc = CommonHandler._getAdditionalResource(eventContext,'additionalasset');
		...
		callGMaps: function(eventContext){
        	var curWO = CommonHandler._getAdditionalResource(eventContext,'workOrder').getCurrentRecord();
        	var longitude = curWO.getPendingOrOriginalValue('Xwoservicelongitudex');
        	var latitude = curWO.getPendingOrOriginalValue('Ywoservicelatitudey');

        	var url = "http://www.google.com/maps/search/?api=1&query=";
        ...
        callWaze: function(eventContext){
        	var curWO = CommonHandler._getAdditionalResource(eventContext,'workOrder').getCurrentRecord();
        	var longitude = curWO.getPendingOrOriginalValue('Xwoservicelongitudex');
        	var latitude = curWO.getPendingOrOriginalValue('Ywoservicelatitudey');
        			
        	var url = "https://waze.com/ul?ll=";
        	url = url + latitude + "," + longitude;
            window.open(url, '_system');   
        },
